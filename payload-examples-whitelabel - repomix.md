This file is a merged representation of `payload/examples/whitelabel/` codebase (https://github.com/payloadcms/payload/tree/main/examples/whitelabel), combined into a single document by Repomix. This example demonstrates how to re-brand or white-label the [Payload Admin Panel](https://payloadcms.com/docs/admin/overview#the-admin-panel) by modifying the favicon, icon, logo, ogImage and title suffix.
...
## File: src/graphics/Icon/index.tsx
```typescript
import React from 'react'
...
## File: src/graphics/Logo/index.tsx
```typescript
import React from 'react'
