...
## File: src/app/(frontend)/(sitemaps)/pages-sitemap.xml/route.ts
````typescript
...
## File: src/app/(frontend)/(sitemaps)/posts-sitemap.xml/route.ts
````typescript
import { getServerSideSitemap } from 'next-sitemap'
import { getPayload } from 'payload'
import config from '@payload-config'
...
## File: src/app/(frontend)/search/page.client.tsx
````typescript
'use client'
import { useHeaderTheme } from '@/providers/HeaderTheme'
import React, { useEffect } from 'react'
...
## File: src/blocks/Code/CopyButton.tsx
````typescript
'use client'
import { Button } from '@/components/ui/button'
...
## File: src/components/AdminBar/index.scss
````scss
...
## File: src/endpoints/seed/image-3.ts
````typescript
import type { Media } from '@/payload-types'
...
## File: src/endpoints/seed/image-hero-1.ts
````typescript
import type { Media } from '@/payload-types'
...
## File: src/Footer/hooks/revalidateFooter.ts
````typescript
...
## File: src/Header/hooks/revalidateHeader.ts
````typescript
import type { GlobalAfterChangeHook } from 'payload'
...
## File: src/utilities/formatAuthors.ts
````typescript
